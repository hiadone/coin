...
SELECT mem_register_datetime FROM `cb_member` WHERE left(mem_register_datetime, 10) >= '".$start_date."' AND left(mem_register_datetime, 10) <= '".$end_date."' AND `mem_denied` =0  
 UNION
SELECT mem_register_datetime FROM `cb_memberleave` WHERE left(mem_register_datetime, 10) >= '".$start_date."' AND left(mem_register_datetime, 10) <= '".$end_date."' AND `mem_denied` =0  
