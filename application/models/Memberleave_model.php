...
class Memberleave_model extends CB_Model
{

    /**
     * 테이블명
     */
    public $_table = 'memberleave';
    ...
    public function get_admin_list($limit = '', $offset = '', $where = '', $like = '', $findex = '', $forder = '', $sfield = '', $skeyword = '', $sop = 'OR')
    {
        ...
        if (isset($where['mgr_id'])) {
            $select = 'memberleave.*';
            $join[] = array('table' => 'member_group_member', 'on' => 'memberleave.mem_id = member_group_member.mem_id', 'type' => 'left');
        }
