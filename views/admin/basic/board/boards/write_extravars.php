                            ...
                            <div class="form-group list-group-item">
                                ...
                                <div class="col-sm-2">
                                    <select name="field_type[<?php echo $key; ?>]" class="form-control field_type">
                                        ...
                                        <option value="datetime" <?php echo element('field_type', $result) === 'datetime' ? ' selected="selected" ' : ''; ?>>시간(연월일시분초)</option>
                                    </select>
