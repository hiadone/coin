        ...
        ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir); ?>">트위터관리</a></li>
                    <li role="presentation"><a href="<?php echo admin_url($this->pagedir . '/group'); ?>">트위터 위치 관리</a></li>
                </ul>
                <?php
                ob_start();
                ?>
                    <div class="btn-group pull-right" role="group" aria-label="...">
                        ...
                        <a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger btn-sm">트위터추가</a>
                    </div>
                <?php
                ...
                <div class="btn-group btn-group-sm pull-right" role="group">
                    <a href="?" class="btn btn-sm <?php echo ($this->input->get('ban_activated') !== 'Y' && $this->input->get('ban_activated') !== 'N') ? 'btn-success' : 'btn-default'; ?>">전체트위터</a>
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th><a href="<?php echo element('bng_name', element('sort', $view)); ?>">트위터 위치</a></th>
                            <th>표시기기</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo number_format(element('ban_hit', $result) + 0); ?></td>
                            <td class="text-center"><?php echo number_format(element('ban_order', $result) + 0); ?></td>
