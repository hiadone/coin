    ...
    <div class="box-table">
        <div class="box-table-header">
            <ul class="nav nav-pills">
                <li role="presentation"><a href="<?php echo admin_url($this->pagedir); ?>">트위터클릭</a></li>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            ?>
                                <input type="number" class="form-control" name="day" value="<?php echo set_value('day', 180); ?>" /> 일 이상된 트위터클릭 로그를 모두 검색합니다.
