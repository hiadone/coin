        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 form-inline">
                        가로 :
                        <input type="number" class="form-control" name="ban_width" value="<?php echo set_value('ban_width', element('ban_width', element('data', $view)) + 0); ?>" />px
                        ,
                        세로 :
                        <input type="number" class="form-control" name="ban_height" value="<?php echo set_value('ban_height', element('ban_height', element('data', $view)) + 0); ?>" />px
