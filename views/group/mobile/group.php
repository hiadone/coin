    ...
    <section class="loing_join">
        <ul class="small_font">
            ...
            if($this->member->is_member()){
                ...
                <figure><img src="'.base_url('assets/images/small_spoon_'.$this->member->item('mem_level').'.png').'" alt="spoon"><figcaption>'.$this->member->item('mem_nickname').
                ...
                echo '<li>|</li>';
                echo '<li onClick=\'location.href="'.site_url('login?url=' . urlencode(current_full_url())).'";\'  title="회원가입" style="width:32%;">회 원 가 입</li>';
            }
            ?>
