        ...
        <ul>
            ...
            <thead>
                <tr>
                    ...
                    <th class='post_num'>번 호</th>
                    <th class='post_title'>제 목</th>
                    <th class="spoon-img">닉 네 임</th>
                    <th class='post_data'>날 짜</th>
                    <th class='post_click'>조 회</th>
                </tr>
            </thead>
            <tbody>
                <?php
                if (element('list', element('data', element('list', $view)))) {
                    foreach (element('list', element('data', element('list', $view))) as $result) {
                        ...
                        <tr>
                            ...
                            <td class='post_num'><?php echo element('num', $result); ?></td>
                            <td class='post_title' style="text-align: left;padding-left:20px;">
                                ...
                                <?php if (element('post_reply', $result)) { ?><span class="label label-primary" style="margin-left:<?php echo strlen(element('post_reply', $result)) * 10; ?>px">Re</span><?php } ?>
                                    <a href="<?php echo element('post_url', $result); ?>" style="
                                        ...
                                        <td class='post_data'><?php echo element('display_datetime', $result); ?></td>
                                        <td class='post_click'><?php echo number_format(element('post_hit', $result)); ?></td>
                                    </tr>
                                    <?php
                                }
                            }
                            ...
                            <section class="post_sear">
                                <form class="navbar-form navbar-right" action="<?php echo board_url(element('brd_key', element('board', element('list', $view)))); ?>" onSubmit="return postSearch(this);">
                                    ...
                                    <input type="search" class="" placeholder="Search" onfocus="this.placeholder=''" onblur="this.placeholder='Search'" name="skeyword" value="<?php echo html_escape($this->input->get('skeyword')); ?>" />
