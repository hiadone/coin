    ...
    <!-- tab08 영역 -->
        <section class='tab08 wrap middle_font'>
            <ul class="tab08_tabs tabs">
                <li class='active' rel='tab08_hottext'>인기글</li>
                <li rel='tab08_newtext'>최신글</li>
                <li rel='tab08_newreply' style="width: 34%;">최신댓글</li>
            </ul>
                ...
                <div id='tab09_drama' class='tab09_cont cont'>
                    <ul>
                        <li>
                             <a href=''>
                                 <figure>
                                     <img src='http://cmy.bitcoissue.com/assets/images/toon01.png' alt='toon01'>
                                     <figcaption>
