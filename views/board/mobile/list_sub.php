...
<article class="wrap01">
    ...
    <section class="tab06 wrap middle_font" style="border-bottom:0;">
        <ul class="tab06_tabs tabs">
            ...
            <?php 
                if(element('brd_key', element('board', element('list', $view)))==='live_news' && $this->input->get('post_notice')) echo '인기뉴스';
                else echo html_escape(element('board_name', element('board', element('list', $view))));
